<template> 
 <div class="block">   
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="title" label="公告标题" width="300" sortable>
			</el-table-column>
      <el-table-column  label="公告类型" min-width="120">
                    ...
                    <el-form-item label="*标题">
                     ...
                     <el-form-item label="状态">
                        <el-radio-group v-model="subData.type">
                          ...
                          <el-radio label="20">项目公告</el-radio>
                        </el-radio-group>
			        	</el-form-item>
  ...
  import {isNoticeState} from '../../api/format';
    ...
    isNoticeState,
      ...
      handleCurrentChange(val) {
		...
		/**
		 * 1.get 请求传公告，必须是json前面加一个params
		 * 2.post传公告不需要在json对象传值前面带params
		 */
		this.loadData();
      ...
      open(){
          if(this.formtitle == '新增公告'){
           ...
           if(this.subData.title.trim().length ==0 || this.subData.title == null){
              ...
              RequestPost("/sysNotice/add",this.subData).then(response => {
            ...
            if(this.subData.title.trim().length ==0 || this.subData.title == null){
              ...
              RequestPost("/sysNotice/update",this.subData).then(response => {
	  ...
	  deleteRow(index, rows) {
       this.$confirm('确认删除, 是否继续?', '提示', {
            ...
            RequestPost("/sysNotice/delete",rows).then(response => {
        ...
        loadData(){
          ...
          RequestGet("/sysNotice/findAll",this.page).then(response => {
                  if(response.code == '0000'){
